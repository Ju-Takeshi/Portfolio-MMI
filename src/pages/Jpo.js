    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div style={{ maxWidth: "1000px"}}>
        <p style={{fontSize: "25px", wordSpacing: "2px", color:"#white"}}>
          ...
          J'ai également eu le droit à une présentation de l'établissement plus précisément la partie INFO / MMI.<br></br>   
          Leur disponibilité m'a permis d'approfondir mes renseignements concernant la formation BUT MMI afin d'avoir une réelle idée de ce qui pouvait m'attendre.
        </p>
      </div>
      ...
      <div style={{ maxWidth: "1000px", }}>
        ...
        <p style={{fontSize: "25px", wordSpacing: "2px", color:"#white"}}>
          ...
          Les rencontres que j'ai pu faire m'ont données encore plus envie d'être l'un des étudiants en BUT MMI de l'iut de Lens.<br></br> 
